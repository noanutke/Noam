...
cmds_calibration = {
       ...
       # "39.5": bytearray([9, 0, 0, 0, 72, 166, 15, 88, 1, 33, 0, 0, 0]),  # 100001
        "40.0": bytearray([9, 0, 0, 0, 175, 166, 15, 88, 1, 34, 0, 0, 0]),  # 100010
        #"40.5": bytearray([9, 0, 0, 0, 58, 239, 194, 87, 1, 35, 0, 0, 0]),  # 100011
        "41.0": bytearray([9, 0, 0, 0, 223, 164, 15, 88, 1, 36, 0, 0, 0]),  # 100100
    # "41.5": bytearray([9, 0, 0, 0, 223, 164, 15, 88, 1, 52, 0, 0, 0]),  # 110100
        "42.0": bytearray([9, 0, 0, 0, 223, 164, 15, 88, 1, 53, 0, 0, 0]),  #110101
    #  "42.5": bytearray([9, 0, 0, 0, 32, 239, 194, 87, 1, 37, 0, 0, 0]),  # 100101
        "43.0": bytearray([9, 0, 0, 0, 17,
                           167, 15, 88, 1, 38, 0, 0, 0]),  # 100110
    #  "43.5": bytearray([9, 0, 0, 0, 52, 49, 72, 88, 1, 39, 0, 0, 0]),  # 100111
        "44.0": bytearray([9, 0, 0, 0, 196, 52, 72, 88, 1, 40, 0, 0, 0]),  # 101000
    #  "44.5": bytearray([9, 0, 0, 0, 196, 52, 72, 88, 1, 41, 0, 0, 0]),  # 101001

        "45.0": bytearray([9, 0, 0, 0, 196, 52, 72, 88, 1, 42, 0, 0, 0]),  # 101010
    #  "45.5": bytearray([9, 0, 0, 0, 196, 52, 72, 88, 1, 43, 0, 0, 0]),  # 101011
        "46.0": bytearray([9, 0, 0, 0, 196, 52, 72, 88, 1, 44, 0, 0, 0]),  # 101100
    # "46.5": bytearray([9, 0, 0, 0, 196, 52, 72, 88, 1, 45, 0, 0, 0]),  # 101101
        "47.0": bytearray([9, 0, 0, 0, 196, 52, 72, 88, 1, 46, 0, 0, 0]),  # 101110
    # "47.5": bytearray([9, 0, 0, 0, 196, 52, 72, 88, 1, 47, 0, 0, 0]),  # 101111
...
cmd_stimuli = {"39": bytearray([9, 0, 0, 0, 185, 223, 16, 88, 1, 22, 0, 0, 0]),  # 010110
        ...
        "40": bytearray([9, 0, 0, 0, 175, 166, 15, 88, 1, 20, 0, 0, 0]),  # 010100
        #"40.5": bytearray([9, 0, 0, 0, 58, 239, 194, 87, 1, 16, 0, 0, 0]),  # 010000
        "41": bytearray([9, 0, 0, 0, 223, 164, 15, 88, 1, 18, 0, 0, 0]),  # 010010
        #"41.5": bytearray([9, 0, 0, 0, 223, 164, 15, 88, 1, 51, 0, 0, 0]),  # 110011
        "42": bytearray([9, 0, 0, 0, 32, 239, 194, 87, 1, 17, 0, 0, 0]),  # 010001
        #"42.5": bytearray([9, 0, 0, 0, 17, 167, 15, 88, 1, 21, 0, 0, 0]),  # 010101
        "43": bytearray([9, 0, 0, 0, 52, 49, 72, 88, 1, 23, 0, 0, 0]),  # 010111
        #"43.5": bytearray([9, 0, 0, 0, 196, 52, 72, 88, 1, 24, 0, 0, 0]),  # 011000
        "44": bytearray([9, 0, 0, 0, 196, 52, 72, 88, 1, 25, 0, 0, 0]),  # 011001
        #"44.5": bytearray([9, 0, 0, 0, 196, 52, 72, 88, 1, 26, 0, 0, 0]),  # 011010
        "45": bytearray([9, 0, 0, 0, 196, 52, 72, 88, 1, 27, 0, 0, 0]),  # 011011
        #"45.5": bytearray([9, 0, 0, 0, 196, 52, 72, 88, 1, 28, 0, 0, 0]),  # 011100
        "46": bytearray([9, 0, 0, 0, 196, 52, 72, 88, 1, 29, 0, 0, 0]),  # 011101
        #"46.5": bytearray([9, 0, 0, 0, 196, 52, 72, 88, 1, 30, 0, 0, 0]),  # 011110
        "47": bytearray([9, 0, 0, 0, 196, 52, 72, 88, 1, 31, 0, 0, 0]), # 011111
        #"47.5": bytearray([9, 0, 0, 0, 196, 52, 72, 88, 1, 49, 0, 0, 0]), #110001
        "48": bytearray([9, 0, 0, 0, 196, 52, 72, 88, 1, 50, 0, 0, 0]),}  # 110010
